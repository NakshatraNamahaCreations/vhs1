...
class WhatsAppTextMessage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      response: null,
  ...
  sendMessage = async () => {
    const url = 'https://wa.chatmybot.in/gateway/waunofficial/v1/api/v2/message';
    const token = '123455#121##$1234'; // Replace with your actual access token
    ...
    const body = [
      {
        ...
        messageType: 0,
        textMessage: {
          content: 'https://app.getpostman.com/join-team?invite_code=e6af8f7e04d813b77c7a9e66d9149eeb&ws=8f1d59d8-e975-4292-a9a7-a131044177d2',
        },
      },
    ];
  ...
  render() {
    ...
    return (
      <div>
        <h1>Send WhatsApp Text Message</h1>
